var X=Object.defineProperty;var Y=(o,e,r)=>e in o?X(o,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[e]=r;var h=(o,e,r)=>(Y(o,typeof e!="symbol"?e+"":e,r),r);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function r(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(i){if(i.ep)return;i.ep=!0;const a=r(i);fetch(i.href,a)}})();class I{constructor(e){h(this,"points");this.points=e.map(r=>r.clone())}}class z{constructor({x:e,y:r,z:t}){h(this,"x");h(this,"y");h(this,"z");this.x=e,this.y=r,this.z=t}clone(){return new z({x:this.x,y:this.y,z:this.z})}}class L{constructor({a:e,b:r,c:t}){h(this,"a");h(this,"b");h(this,"c");this.a=e,this.b=r,this.c=t}computeNormal(){const e=new z({x:this.b.x-this.a.x,y:this.b.y-this.a.y,z:this.b.z-this.a.z}),r=new z({x:this.c.x-this.a.x,y:this.c.y-this.a.y,z:this.c.z-this.a.z}),t=new z({x:e.y*r.z-e.z*r.y,y:e.z*r.x-e.x*r.z,z:e.x*r.y-e.y*r.x}),i=Math.sqrt(t.x*t.x+t.y*t.y+t.z*t.z);return t.x/=i,t.y/=i,t.z/=i,t}flip(){return new L({a:this.a.clone(),b:this.c.clone(),c:this.b.clone()})}}function n(o,e){return new z({x:o,y:0,z:e})}class W{constructor({innerDiameter:e,innerZ:r,outerDiameter:t,outerZ:i,direction:a}){h(this,"innerDiameter");h(this,"innerZ");h(this,"outerDiameter");h(this,"outerZ");h(this,"direction");this.innerDiameter=e,this.innerZ=r,this.outerDiameter=t,this.outerZ=i,this.direction=a}getTriangles(){let e=E(this.innerDiameter,this.innerZ),r=E(this.outerDiameter,this.outerZ);this.direction&&([e,r]=[r,e]);const t=[];for(let i=0;i<C;i++){const a=[e[i],e[(i+1)%C],r[i],r[(i+1)%C]];t.push(new L({a:a[0],b:a[1],c:a[2]})),t.push(new L({a:a[1],b:a[3],c:a[2]}))}return t}}const C=300,k=[];for(let o=0;o<C;o++){const e=o*2*Math.PI/C;k.push(new z({x:Math.cos(e),y:Math.sin(e),z:0}))}function E(o,e){return k.map(r=>new z({x:r.x*o/2,y:r.y*o/2,z:e}))}function O(o){let e=[];for(let t=0;t<o.points.length;t++){const i=o.points[t],a=o.points[(t+1)%o.points.length];e.push(new W({innerDiameter:i.x*2,innerZ:i.z,outerDiameter:a.x*2,outerZ:a.z,direction:!1}))}let r=[];for(let t=0;t<e.length;t++)r=r.concat(e[t].getTriangles());return r}const R=1,u=.5,x=2,H=1.25;class V{constructor({outerDiameter:e,boreDiameter:r,width:t,clearance:i}){h(this,"outerDiameter");h(this,"boreDiameter");h(this,"width");h(this,"clearance");this.outerDiameter=e,this.boreDiameter=r,this.width=t,this.clearance=i}get sliderInnerDiameter(){return this.boreDiameter+(this.outerDiameter-this.boreDiameter)/3}get sliderOuterDiameter(){return this.boreDiameter+2*(this.outerDiameter-this.boreDiameter)/3}getTriangles(){return[...this.getTrianglesForInnerRing(),...this.getTrianglesForSlider(),...this.getTrianglesForOuterRing()]}trianglesWithMirroredBottom(e){const r=e.map(t=>(t=t.flip(),t.a.z=this.width-t.a.z,t.b.z=this.width-t.b.z,t.c.z=this.width-t.c.z,t));return[...e,...r]}getTrianglesForInnerRing(){return O(this.innerRingPolygon)}get innerRingPolygon(){let e=this.boreDiameter/2,r=this.sliderInnerDiameter/2-this.clearance,t=r-R;return new I([n(e,0),n(r,0),n(r,u),n(t,u+x),n(t,this.width-u-x),n(r,this.width-u),n(r,this.width),n(e,this.width)])}getTrianglesForSlider(){return O(this.sliderPolygon)}get sliderPolygon(){const e=this.sliderInnerDiameter/2,r=e-R,t=this.sliderOuterDiameter/2,i=t+R;return new I([n(e,0),n(t,0),n(t,u),n(i,u+x),n(i,this.width-u-x),n(t,this.width-u),n(t,this.width),n(e,this.width),n(e,this.width-u),n(r,this.width-u-x),n(r,u+x),n(e,u)])}getTrianglesForOuterRing(){return O(this.outerRingPolygon)}get outerRingPolygon(){const e=this.sliderOuterDiameter/2+this.clearance,r=e+R;return new I([n(this.outerDiameter/2,0),n(this.outerDiameter/2,this.width),n(e,this.width),n(e,this.width-u),n(r,this.width-u-x),n(r,u+x),n(e,u),n(e,0)])}drawPreview(e){let r=this.innerRingPolygon,t=this.sliderPolygon,i=this.outerRingPolygon;const a=[r,t,i],l=Math.max(...a.map(p=>p.points.reduce((m,g)=>Math.max(m,g.x),-1/0))),b=-l,c=Math.min(...a.map(p=>p.points.reduce((m,g)=>Math.min(m,g.z),1/0))),f=Math.max(...a.map(p=>p.points.reduce((m,g)=>Math.max(m,g.z),-1/0)));console.log({minX:b,maxX:l,minY:c,maxY:f});const y=e.width,w=e.height,D=y/(l-b),T=w/(f-c),S=Math.min(D,T)*.8;console.log({scale:S});const M=y/2-(l+b)/2*S,v=w/2-(f+c)/2*S,d=p=>n(p.x*S+M,p.z*S+v);console.log(d(n(11,8)));const s=e.getContext("2d");s.clearRect(0,0,y,w),s.fillStyle="rgba(0, 0, 0, 1)",s.fillRect(0,0,y,w);const U=d(n(-this.boreDiameter/2,0)),$=d(n(this.boreDiameter/2,0)),P=s.createLinearGradient(U.x,0,$.x,0),Z="rgba(206, 207, 176, 1)",B="rgba(102, 102, 69, 1)";P.addColorStop(0,B),P.addColorStop(.45,Z),P.addColorStop(.55,Z),P.addColorStop(1,B),s.fillStyle=P,s.fillRect(d(n(b,c)).x,d(n(b,c)).z,d(n(l,f)).x-d(n(b,c)).x,d(n(l,f)).z-d(n(b,c)).z);const q=d(n(b,c)),j=d(n(l,f)),F=s.createLinearGradient(q.x,q.z,j.x,q.z);F.addColorStop(0,"rgba(255, 200, 90, 1)"),F.addColorStop(.5,"rgba(240, 229, 200, 1)"),F.addColorStop(1,"rgba(226, 194, 100, 1)"),s.fillStyle=F;for(const p of a){const m=p.points.map(d);s.beginPath(),s.moveTo(m[0].x,m[0].z);for(const g of m.slice(1))s.lineTo(g.x,g.z);s.closePath(),s.fill()}for(const p of a){const m=p.points.map(g=>{const A=d(g);return n(y-A.x,A.z)});s.beginPath(),s.moveTo(m[0].x,m[0].z);for(const g of m.slice(1))s.lineTo(g.x,g.z);s.closePath(),s.fill()}}get fileName(){const e=r=>r.toFixed(2).replace(/\.?0*$/,"");return`bearing-${e(this.boreDiameter)}-${e(this.outerDiameter)}-${e(this.width)}-${e(this.clearance)}.stl`}validate(){if(this.boreDiameter>=this.sliderInnerDiameter-H*2-this.clearance*2)throw new Error("Bore diameter is too large for the outer diameter")}}function J(o){const i=84+o.length*50,a=new Uint8Array(i),l=new DataView(a.buffer);for(let c=0;c<80;c++)a[c]=0;const b=o.length;l.setInt32(80,b,!0);for(let c=0;c<o.length;c++){const f=o[c],y=f.computeNormal(),w=f.a,D=f.b,T=f.c,S=80+4+c*50,M=[y.x,y.y,y.z,w.x,w.y,w.z,D.x,D.y,D.z,T.x,T.y,T.z];for(let v=0;v<M.length;v++)l.setFloat32(S+v*4,M[v],!0)}return a}function K(){let o=N(),e=o.getTriangles();const r=J(e);let t=document.createElement("a");t.download=o.fileName;let i=new Blob([r],{type:"application/octet-stream"});t.href=URL.createObjectURL(i),t.click()}function G(){let o=N(),e=document.querySelector("#preview");o.drawPreview(e)}function Q(){let o=N();try{o.validate(),document.querySelector("#error").textContent=""}catch(e){e instanceof Error?document.querySelector("#error").textContent=e.message:document.querySelector("#error").textContent="Unknown error"}}function N(){let o=parseFloat(document.querySelector("#outer-diameter").value),e=parseFloat(document.querySelector("#bore-diameter").value),r=parseFloat(document.querySelector("#width").value),t=parseFloat(document.querySelector("#clearance").value);return new V({outerDiameter:o,boreDiameter:e,width:r,clearance:t})}const _=""+new URL("hero-a236bb3a.jpg",import.meta.url).href;document.querySelector("#app").innerHTML=`
...
`;document.querySelector("#generate").addEventListener("click",()=>{K()});document.querySelectorAll("#app input").forEach(o=>{o.addEventListener("change",()=>{let e=r=>{let t=document.querySelector(r),i=parseFloat(t.min),a=parseFloat(t.max),l=t.valueAsNumber;l<i?t.value=i.toString():l>a&&(t.value=a.toString())};e("#outer-diameter"),e("#bore-diameter"),e("#width"),e("#clearance"),Q(),G()})});G();
